...
//		return c.getTimeInMillis();
     ...
     * 只处理5.0以上的版本
     */
    public static void initStatusBar(Activity activity, int barColor) {
        /**
         * Build.VERSION.SDK_INT  软件运行的手机系统版本
         */
...
//            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            ...
            window.setStatusBarColor(activity.getResources().getColor(barColor));
